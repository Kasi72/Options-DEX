...
normalized_snapshots = Table(
    ...
    Column("raw_snapshot_id", String(64), ForeignKey("raw_snapshots.snapshot_id"), nullable=False),
    ...
    UniqueConstraint("raw_snapshot_id", "content_sha256", name="uq_normalized_snapshot_content"),
)
...
option_quotes = Table(
    ...
    metadata,
    Column("id", Integer, primary_key=True),
    Column("normalized_snapshot_id", Integer, ForeignKey("normalized_snapshots.id"), nullable=False),
    ...
    UniqueConstraint("normalized_snapshot_id", "ordinal", name="uq_option_quote_ordinal"),
)
...
signal_events = Table(
    ...
    metadata,
    Column("id", Integer, primary_key=True),
    Column("signal_id", String(128), ForeignKey("research_signals.signal_id"), nullable=False),
